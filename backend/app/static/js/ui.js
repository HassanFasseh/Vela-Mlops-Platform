...
const UI = (() => {
  ...
  // and this platform's backend is served over plain HTTP, so it's
  // commonly undefined entirely rather than just rejecting, which is
  // what made the API-key "Copy" buttons look like they silently did
  // nothing. document.execCommand('copy') is
